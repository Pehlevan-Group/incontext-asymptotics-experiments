...
tvals = np.linspace(0.1,2.1,21) #np.linspace(0.95,1.15,11) #np.linspace(0.1,2.1,21)
...
state, hist = train(config, data_iter=iter(trainobject), batch_size=int(P), loss='mse', test_every=100, train_iters=5000, optim=optax.sgd,lr=1e-4)
